      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <Button
            ...
            className={
              showIncorrectOnly ? "bg-red-50 border-red-200 text-red-700" : ""
            }
          >
            {showIncorrectOnly ? "Show All" : "Incorrect Only"}
          </Button>
          <Button
            variant="ghost"
            size="sm"
        ...
        <div className="space-y-6">
          {(() => {
            // Filter questions based on showIncorrectOnly setting
            let filteredQuestions = session.questions;

            if (showIncorrectOnly) {
              filteredQuestions = session.questions.filter((question) => {
